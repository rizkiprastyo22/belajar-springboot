...
public class Hero implements Attackable, Hilebel {
    private String name;
    private Integer hp;
    ...
    public void attack(Attackable attackable) {
        attackable.receivedDamage(this);

//        if (enemy.hp <= 0) {
//            System.out.println("Musuh sudah mati");
//        } else {
//            enemy.receivedDamage(this);
//        }
...
//        monster.receivedDamage(this);
//
////        monster.setHp(monster.getHp() - this.baseDamage);
//    }
//
//    public void attack(Tower tower) {
//        tower.receivedDamage(this);
//    }
